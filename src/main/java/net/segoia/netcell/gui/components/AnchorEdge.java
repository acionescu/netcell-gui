...
import net.segoia.swing.util.shapes.Vector2D;
...
//	    }
	...
	Point2D middle = edge.getMiddle();
	Vector2D normal = edge.getNormal();
	return new Point2D.Double(middle.getX()-normal.getDx()*dist, middle.getY()-normal.getDy()*dist);
    }
