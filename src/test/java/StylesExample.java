...
public class StylesExample extends JPanel
    ...
    private JEditorPane createEditorPane() {
        ...
        java.net.URL helpURL = StylesExample.class.getResource(
    ...
    protected static ImageIcon createImageIcon(String path,
                                               String description) {
        java.net.URL imgURL = StylesExample.class.getResource(path);
        if (imgURL != null) {
